...
# new_pet is 100
#
# checking to see if zsolt has enough cash to afford new_pet. which he doesnt, which is why it returns false
#
# so create a function to work out whether zsolt has sufficient funds to buy new_pet.
...
# # 20
  ...
  # test to sell pet to customer. so for customer[0], craig, find pet "arthur" in the shop.
  # this will then increase the customer craigs pet count to one.
